...
const WorkerTransactionEdit = ({ navigation, route }: any) => {
  ...
  const {
    ...
    loading,
    hasUnsavedChanges
  } = useWorkerTransactionEdit({ navigation, id });
  ...
  return (
    <View style={commonStyle.container}>
      ...
      <Header title="Edit Worker Transaction" onBackPress={handleBackPress} />
      <KeyboardAvoidingView
...
export default WorkerTransactionEdit;
