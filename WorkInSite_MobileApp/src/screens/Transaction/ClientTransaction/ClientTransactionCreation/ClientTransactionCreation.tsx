...
const ClientTransactionCreation = ({ navigation }: any) => {
  const { t } = useLanguage();
  const {
    handleBackPress,
    handleSelect,
    ...
    error,
    hasUnsavedChanges
  } = useClientTransactionCreation({ navigation });
  ...
  return (
    <View style={commonStyle.container} >
      ...
      <Header title="Create Client Transaction" onBackPress={handleBackPress} />
      <KeyboardAvoidingView
